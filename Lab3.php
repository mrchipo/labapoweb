...
<body>
    <div class="bg">
		...
		<form class="Guest">
			<label for="login" class="infp">Login</label>
			<input type="text" class="in" name="login" id="login" ><br>
			<label for="password" class="infp">Password</label>
			<input type="password" class="in"  name="password" id="password" ><br>
			<label for="repassword" class="infp">Repeat Password</label>
			<input type="password" class="in" name="repassword" id="repassword" ><br>
			<label for="email" class="infp">Email</label>
			<input type="text" class="in" name="email" id="email"><br>
			<div class='butn'>
